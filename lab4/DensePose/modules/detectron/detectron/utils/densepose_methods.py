...
class DensePoseMethods:
    def __init__(self, DensePoseData_dir):
        #
        ALP_UV = loadmat( os.path.join(os.path.dirname(__file__), 
                                       os.path.join(DensePoseData_dir, 'UV_data/UV_Processed.mat'))  )
        ...
        UV_symmetry_filename = os.path.join(os.path.dirname(__file__), 
                                            os.path.join(DensePoseData_dir, 'UV_data/UV_symmetry_transforms.mat')) 
